...
export const TermsAndConditions: React.FC<Props> = ({ expanded = false }) => (
    <LegalContainer header="Terms & Conditions on Football Simulator Apps" dateUpdated={DateUpdated} expanded={expanded}>
        ...
        <p>
            By downloading or using any Senapp Studios apps, these terms will
            automatically apply to you – you should make sure therefore that
            you read them carefully before using the our apps. You’re not
            ...
            translate the app into other languages without permission from
            Senapp Studios, or make derivative versions. The app itself, and
            all the trade marks, copyright, database rights and other
            intellectual property rights related to it, still belong to Senapp
            Studios and or parties.
        </p>
        <p>
            Senapp Studios is committed to ensuring that the app is as useful
        ...
        <p>
            Senapp Studios can not be held accountable for how you use our
            apps functions or how you name, add, or edit elements in our app,
            this means any insulting, provactive, copyrighted, trademarked, or
            offensive material you have created is not Senapp Studios
            responsible for.
        </p>
        <p>
            Our apps stores and processes personal data that you have provided
            to us, in order to provide our Service. It’s your responsibility
            ...
            the our apps won’t work properly or at all.
        </p>
        <p>
            You should be aware that there are certain things that Senapp
            ...
            provider, but Senapp Studios cannot take responsibility for the
        ...
        <p>
            Along the same lines, Senapp Studios cannot always take
            ...
            and you can’t turn it on to avail the Service, Senapp Studios
            cannot accept responsibility.
        </p>
        <p>
            With respect to Senapp Studios’s responsibility for your use of
            ...
            information to us so that we can make it available to you. Senapp
            Studios accepts no liability for any loss, direct or indirect, you
            experience as a result of relying wholly on this functionality of
            the app.
        </p>
        <p>
            At some point, we may wish to update the app. The app is currently
            available on Android and IOS – the requirements for system(and for
            ...
            want to keep using the app. Senapp Studios does not promise that
            it will always update the app so that it is relevant to you and/or
            works with the Android or IOS version that you have installed on
